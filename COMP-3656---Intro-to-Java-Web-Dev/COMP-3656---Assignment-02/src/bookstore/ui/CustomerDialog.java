...
import .bookstore.database.CustomerDAO;
...
public class CustomerDialog extends JDialog {
	 ...
	 * @throws SQLException
	 */
	public CustomerDialog(CustomerDAO newDao, int index) throws SQLException {
		this.dao = newDao;
		...
		}
		{
			...
			fieldID.setText(String.valueOf(dao.get(index).getId()));
		...
		}
		{
			...
			fieldFirstName.setText(dao.get(index).getFirstName());
		...
		}
		{
			...
			fieldLastName.setText(dao.get(index).getLastName());
		...
		}
		{
			...
			fieldStreet.setText(dao.get(index).getStreetName());
		...
		}
		{
			...
			fieldCity.setText(dao.get(index).getCity());
		...
		}
		{
			...
			fieldPostal.setText(dao.get(index).getPostalCode());
		...
		}
		{
			...
			fieldPhone.setText(dao.get(index).getPhoneNumber());
		...
		}
		{
			...
			fieldEmail.setText(dao.get(index).getEmailAddress());
		...
		}
		{
			...
			fieldJoinedDate.setText(dao.get(index).getJoinDate().toString());

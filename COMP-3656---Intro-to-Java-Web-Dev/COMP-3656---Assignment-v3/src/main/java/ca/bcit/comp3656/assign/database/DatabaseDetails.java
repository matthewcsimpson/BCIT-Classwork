...
//	
	...
	public static final String DB_TABLE_NAME 	= "_Employees";

	public static final String DB_CREATE 		= "USE jspweb; CREATE TABLE _Employees (id VARCHAR(9), firstName VARCHAR(250) NOT NULL, lastName VARCHAR(250) NOT NULL, dob DATE, PRIMARY KEY(id))";
